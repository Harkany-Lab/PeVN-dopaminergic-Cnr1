...
```{r plot-dotplot-age-glur-dop, fig.height=5, fig.width=9}
DotPlot(
  object = oc3_fin_neurotrans$dopaminergic,
  features = glutr,
  group.by = "age",
...
```{r plot-dotplot-stage-gabar-dop, fig.height=5, fig.width=9}
DotPlot(
  object = oc3_fin_neurotrans$dopaminergic,
  features = gabar,
  group.by = "stage",
...
```{r plot-dotplot-stage-glur-dop, fig.height=5, fig.width=9}
DotPlot(
  object = oc3_fin_neurotrans$dopaminergic,
  features = glutr,
  group.by = "stage",
...
```{r plot-dotplot-stage-npr-gaba, fig.height=5, fig.width=9}
DotPlot(
  object = oc3_fin_neurotrans$GABAergic,
  features = npr,
  group.by = "stage",
...
```{r plot-dotplot-stage-npr-dop, fig.height=5, fig.width=9}
DotPlot(
  object = oc3_fin_neurotrans$dopaminergic,
  features = npr,
  group.by = "stage",
...
```{r plot-dotplot-stage-cnbn-dop, fig.height=5, fig.width=9}
DotPlot(
  object = oc3_fin_neurotrans$dopaminergic,
  features = cnbn,
  group.by = "stage",
